<div class="flex flex-col items-center basis-1/5">
    <div id="nav" class="flex flex-col items-center h-3/4 w-2/3">
        ...
        <div class="flex flex-row basis-1/12 text-gray-500 text-sm">
            <img class="flex w-6 h-6 mr-5" src="/folder-open.png" alt="?" />
            <button class="flex ml-3 hover:text-blue-800">CTA</button>
        </div>
        <div class="flex flex-row basis-1/12 text-gray-500 text-sm">
            <img class="flex w-6 h-6 mr-5" src="/database.png" alt="?" />
            <button class="flex ml-3 hover:text-blue-800">CTA</button>
        </div>
        <div class="flex flex-row basis-1/12 text-gray-500 text-sm">
            <img class="flex w-6 h-6 mr-5" src="/flickr.png" alt="?" />
            <button class="flex ml-3 hover:text-blue-800">CTA</button>
        </div>
        <div class="flex flex-row basis-1/12 text-gray-500 text-sm">
            <img class="flex w-6 h-6 mr-5" src="/envelop.png" alt="?" />
            <button class="flex ml-3 hover:text-blue-800">CTA</button>
        </div>
        <div class="flex flex-row basis-1/12 text-gray-500 text-sm">
            <img class="flex w-6 h-6 mr-2" src="/cog.png" alt="?" />
            <button class="flex hover:text-blue-800">Settings</button>
        </div>
        <div class="flex flex-row basis-1/12 text-gray-500 text-sm">
            <img class="flex w-6 h-6 mr-2" src="/database.png" alt="?" />
